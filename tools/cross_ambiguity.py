...
caf_result = calculate_caf(waveform, synthetic_ft8, max_delay_samples=400)
...
print("\n================ TEST RESULTS ================")
print(f"Calculated Path Delay: {detected_delay} samples (Expected: {true_delay})")
print(f"Calculated Doppler Shift: {detected_doppler:.2f} Hz (Expected: {true_doppler})")
print("==============================================")
